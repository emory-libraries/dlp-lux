...
# NOTE: This is copied directly from Blacklight v7.33.1's ViewComponentTestHelpers.
module LuxViewComponentTestHelpers
  ...
  def nokogiri_mediated_href(href)
    start = 9 # return of "<a href=\"".length
    stop = -6 # return of -"\"></a>".length
